...
DEFAULT_POSITIVE_RATIO_THRESHOLD = 0.1
DEFAULT_MIN_POSITIVE_TWEETS = 10
DEFAULT_MIN_PROFILE_EVALUATED_TWEETS = 100
DEFAULT_TAKLIDI_RATIO_THRESHOLD = 0.25
DEFAULT_TAKLIDI_RATIO_MARGIN = 0.07
DEFAULT_DEEP_DIVE_TRIGGER_JIHADI_PROBABILITY_THRESHOLD = 0.70
DEFAULT_DEEP_DIVE_TWEET_LIMIT = 150
DEFAULT_PROFILE_OVERFETCH_MULTIPLIER = 1

JIHADI_LABEL_TOKEN = "jihadi"
TAKLIDI_LABEL = "Salafi taklidi"

THREAD_MAX_GAP_SECONDS = 600
